...
function(load_addon_libs target libs LOOKUP_DIR)
  ...
  file(GLOB_RECURSE libs_ ${LOOKUP_DIR}/*.lib)
  ...
  if (EXISTS ${ADDON_DIR}/libs) 
    ...
    foreach(subdir ${SUBDIRS})
      if (EXISTS ${subdir}/include) 
        message(STATUS "Setting include dir: " ${subdir}/include)
        if (TARGET ${addonName})
          target_include_directories(${addonName} PUBLIC ${subdir}/include)
        endif()
        target_include_directories(${target} PUBLIC ${subdir}/include)
      endif()
      if (EXISTS ${subdir}/lib)
        if (WIN32)
          set(STATIC_LIB_DIR vs)
          set(STATIC_LIB_EXT lib)
        elseif (APPLE)
          set(STATIC_LIB_DIR osx)
          set(STATIC_LIB_EXT a)
        endif()

        if (WIN32 OR APPLE)
          set(LIB_ROOT_DIR ${subdir}/lib/${STATIC_LIB_DIR})
          if (EXISTS ${LIB_ROOT_DIR}) 
            file(GLOB libs ${LIB_ROOT_DIR}/*.${STATIC_LIB_EXT})
            if (libs)
